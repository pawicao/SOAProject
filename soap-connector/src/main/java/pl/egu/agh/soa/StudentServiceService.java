 ...
 * 
 */
@WebServiceClient(name = "StudentServiceService", targetNamespace = "http://api.soa.agh.edu.pl/", wsdlLocation = "http://localhost:8080/soa/studentService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName STUDENTSERVICESERVICE_QNAME = new QName("http://api.soa.agh.edu.pl/", "StudentServiceService");
    ...
    public StudentService getStudentServicePort() {
        return super.getPort(new QName("http://api.soa.agh.edu.pl/", "StudentServicePort"), StudentService.class);
    }
    ...
    public StudentService getStudentServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://api.soa.agh.edu.pl/", "StudentServicePort"), StudentService.class, features);
    }
